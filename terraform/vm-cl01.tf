...
resource "proxmox_virtual_environment_vm" "cl01" {
  ...
  provisioner "remote-exec" {
    inline = [
      "powershell -ExecutionPolicy Bypass -Command \"Import-Module C:/lab-provisioning/SILab.psm1 -Force; Start-SILabDetached -ScriptPath 'C:/lab-provisioning/Bootstrap-CL01.ps1' -LocalAdminPassword '${local.ps_local_admin_password}' -DomainAdminPassword '${local.ps_domain_admin_password}'\"",
    ]
  }
}
